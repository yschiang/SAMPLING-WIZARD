...
export const generateWaferGrid = (
  ...
  for (let r = 0; r < height; r++) {
    ...
    for (let c = 0; c < width; c++) {
      ...
      // Simulate value for demo (if selected, give it high score, otherwise random low/empty)
      // In real app, this comes from L4 scoring heatmap.
      // For now, only selected points might have implicit "value" or just "selected" status.
      // The prompt asks for value support. I'll leave value undefined unless we have data.
